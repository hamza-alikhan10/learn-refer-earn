      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <div className="bg-gradient-to-br from-primary/20 to-accent/20 p-4 sm:p-6 rounded-full w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto mb-6 flex items-center justify-center animate-float">
              <Target className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-primary icon-3d" />
            </div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-4 sm:mb-6 font-poppins">How Trading Academy Works</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 mb-12 sm:mb-16">
            {/* Step 1 */}
            <div className="bg-card rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-border group hover:shadow-xl transition-all duration-300">
              <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-6">
                ...
                <div className="text-center sm:text-left">
                  <span className="text-xs sm:text-sm font-semibold text-primary bg-primary/10 px-2 sm:px-3 py-1 rounded-full">Step 1</span>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-card-foreground mt-2 font-poppins">Sign Up</h3>
                </div>
              </div>
            ...
            <div className="bg-card rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-border group hover:shadow-xl transition-all duration-300">
              <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-6">
                ...
                <div className="text-center sm:text-left">
                  <span className="text-xs sm:text-sm font-semibold text-success bg-success/10 px-2 sm:px-3 py-1 rounded-full">Step 2</span>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-card-foreground mt-2 font-poppins">Browse Affiliate Marketing Courses</h3>
                </div>
              </div>
              <p className="text-muted-foreground leading-relaxed text-sm sm:text-base mb-4 font-noto-sans">
            ...
            <div className="bg-card rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-border group hover:shadow-xl transition-all duration-300">
              <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-6">
                ...
                <div className="text-center sm:text-left">
                  <span className="text-xs sm:text-sm font-semibold text-accent bg-accent/10 px-2 sm:px-3 py-1 rounded-full">Step 3</span>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-card-foreground mt-2 font-poppins">Generate Referral Link</h3>
                </div>
              </div>
              <p className="text-muted-foreground leading-relaxed text-sm sm:text-base mb-4 font-noto-sans">
            ...
            <div className="bg-card rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-border group hover:shadow-xl transition-all duration-300">
              <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-6">
                ...
                <div className="text-center sm:text-left">
                  <span className="text-xs sm:text-sm font-semibold text-warning bg-warning/10 px-2 sm:px-3 py-1 rounded-full">Step 4</span>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-card-foreground mt-2 font-poppins">Share with Network</h3>
                </div>
              </div>
              <p className="text-muted-foreground leading-relaxed text-sm sm:text-base mb-4 font-noto-sans">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3">
                <div className="flex items-center space-x-2 sm:space-x-3 bg-blue-50 p-2 sm:p-3 rounded-lg border border-blue-200">
                ...
                <div className="flex items-center space-x-2 sm:space-x-3 bg-green-50 p-2 sm:p-3 rounded-lg border border-green-200">
                ...
                <div className="flex items-center space-x-2 sm:space-x-3 bg-purple-50 p-2 sm:p-3 rounded-lg border border-purple-200">
          ...
          <div className="bg-gradient-to-br from-success/10 to-primary/10 rounded-3xl p-6 sm:p-8 lg:p-12 mb-12 sm:mb-16 border border-success/20">
            <div className="text-center mb-8">
              <div className="bg-gradient-to-br from-success to-success/80 w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg animate-bounce-gentle">
                <Coins className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-success-foreground icon-3d" />
              </div>
              <span className="text-xs sm:text-sm font-semibold text-success bg-success/10 px-3 sm:px-4 py-1 rounded-full">Step 5</span>
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-card-foreground mt-4 mb-4 font-poppins">Earn up to 60% Commission on Every Sale!</h3>
                ...
                <table className="w-full text-left border-collapse min-w-[300px]">
                  <thead>
                    <tr className="bg-muted/50">
                      <th className="p-2 sm:p-3 md:p-4 text-sm sm:text-base font-semibold text-card-foreground font-poppins border-b border-border">Course Price</th>
                      <th className="p-2 sm:p-3 md:p-4 text-sm sm:text-base font-semibold text-card-foreground font-poppins border-b border-border">
                        <span className="inline-flex items-center bg-blue-100 text-blue-900 px-1 sm:px-2 py-1 rounded-full">
                          <Users className="w-3 h-3 sm:w-4 sm:h-4 mr-1" /> Primary - Direct
                        </span>
                      </th>
                      <th className="p-2 sm:p-3 md:p-4 text-sm sm:text-base font-semibold text-card-foreground font-poppins border-b border-border">
                        <span className="inline-flex items-center bg-green-100 text-green-900 px-1 sm:px-2 py-1 rounded-full">
                  ...
                  <tbody>
                    <tr className="hover:bg-muted/30 transition-all duration-200">
                      <td className="p-2 sm:p-3 md:p-4 text-sm sm:text-base text-muted-foreground font-noto-sans border-b border-border">₹1000</td>
                      <td className="p-2 sm:p-3 md:p-4 text-sm sm:text-base font-bold text-blue-600 font-noto-sans border-b border-border">40%</td>
                      <td className="p-2 sm:p-3 md:p-4 text-sm sm:text-base font-bold text-green-600 font-noto-sans border-b border-border">5%</td>
                    </tr>
                    <tr className="hover:bg-muted/30 transition-all duration-200">
                      <td className="p-2 sm:p-3 md:p-4 text-sm sm:text-base text-muted-foreground font-noto-sans border-b border-border">₹3000</td>
                      <td className="p-2 sm:p-3 md:p-4 text-sm sm:text-base font-bold text-blue-600 font-noto-sans border-b border-border">50%</td>
                      <td className="p-2 sm:p-3 md:p-4 text-sm sm:text-base font-bold text-green-600 font-noto-sans border-b border-border">8%</td>
                    </tr>
                    <tr className="hover:bg-muted/30 transition-all duration-200">
                      <td className="p-2 sm:p-3 md:p-4 text-sm sm:text-base text-muted-foreground font-noto-sans border-b border-border">₹5000</td>
                      <td className="p-2 sm:p-3 md:p-4 text-sm sm:text-base font-bold text-blue-600 font-noto-sans border-b border-border">60%</td>
                      <td className="p-2 sm:p-3 md:p-4 text-sm sm:text-base font-bold text-green-600 font-noto-sans border-b border-border">10%</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p className="text-center text-sm sm:text-base md:text-lg text-muted-foreground mt-4 sm:mt-6 font-noto-sans">
                Refer and earn big! Get rewarded for both direct and indirect referrals.
              </p>
            </div>

            <div className="bg-card border border-border rounded-xl p-3 sm:p-4 md:p-6 shadow-md mb-6 sm:mb-8">
              <h4 className="font-bold text-card-foreground mb-3 sm:mb-4 text-center text-lg sm:text-xl md:text-2xl font-poppins">Commission Examples</h4>
              <div className="space-y-2 sm:space-y-3">
                <div className="flex flex-col sm:flex-row justify-between items-center p-2 sm:p-3 bg-muted/30 rounded-lg">
            ...
            {/* Program Benefits */}
            <div className="bg-card rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-border mb-6 sm:mb-8">
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-card-foreground mb-6 flex items-center font-poppins">
                <Award className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 mr-3 text-success icon-3d" />
                Program Benefits
              </h2>
              <div className="space-y-3 sm:space-y-4">
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-3 sm:p-4 rounded-xl border border-blue-200">
                  <h3 className="font-semibold text-blue-900 mb-1 sm:mb-2 flex items-center text-sm sm:text-base md:text-lg font-noto-sans">
                    <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 mr-2 icon-3d" />
                ...
                <div className="bg-gradient-to-r from-green-50 to-green-100 p-3 sm:p-4 rounded-xl border border-green-200">
                  <h3 className="font-semibold text-green-900 mb-1 sm:mb-2 flex items-center text-sm sm:text-base md:text-lg font-noto-sans">
                    <Coins className="w-4 h-4 sm:w-5 sm:h-5 mr-2 icon-3d" />
                ...
                <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-3 sm:p-4 rounded-xl border border-purple-200">
                  <h3 className="font-semibold text-purple-900 mb-1 sm:mb-2 flex items-center text-sm sm:text-base md:text-lg font-noto-sans">
                    <Clock className="w-4 h-4 sm:w-5 sm:h-5 mr-2 icon-3d" />
                    Real-Time Tracking
                  </h3>
                ...
                <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-3 sm:p-4 rounded-xl border border-orange-200">
                  <h3 className="font-semibold text-orange-900 mb-1 sm:mb-2 flex items-center text-sm sm:text-base md:text-lg font-noto-sans">
                    <Gift className="w-4 h-4 sm:w-5 sm:h-5 mr-2 icon-3d" />
                    Milestone Bonuses
                  </h3>
            ...
            <div className="bg-muted/30 rounded-2xl p-4 sm:p-6 lg:p-8 mb-12 sm:mb-16 border border-border">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-card-foreground mb-6 text-center flex items-center justify-center font-poppins">
                <Shield className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 mr-3 text-primary icon-3d" />
                Terms and Conditions
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                <div className="bg-card rounded-xl p-3 sm:p-4 md:p-6 shadow-sm border border-border">
                  <h3 className="font-bold text-card-foreground mb-2 flex items-center text-sm sm:text-base md:text-lg font-poppins">
                    <Coins className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-success icon-3d" />
                    Commission Structure
                  </h3>
                  <ul className="space-y-2 text-muted-foreground text-xs sm:text-sm md:text-base font-noto-sans">
          ...
          {/* CTA Section */}
          <div className="bg-gradient-to-r from-primary to-accent rounded-2xl p-4 sm:p-6 md:p-8 lg:p-12 text-primary-foreground text-center">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 font-poppins">Ready to Start Earning?</h2>
            <p className="mb-6 sm:mb-8 text-primary-foreground/90 text-sm sm:text-base md:text-lg max-w-xl sm:max-w-2xl md:max-w-3xl mx-auto leading-relaxed font-noto-sans">
